...
const ClientTypes = () => {
  ...
  const fetchTypes = async () => {
    try {
      ...
      toast.error("Error al cargar tipos de cliente");
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.post(`${API}/client-types`, formData, { withCredentials: true });
  ...
  const handleDelete = async (typeId) => {
    if (window.confirm("¿Estás seguro de eliminar este tipo?")) {
      try {
        await axios.delete(`${API}/client-types/${typeId}`, { withCredentials: true });
  ...
  return (
    <Layout title="Tipos de Cliente">
      <div className="space-y-6" data-testid="client-types-page">
        <div className="flex justify-end">
          <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
            <DialogTrigger asChild>
              <Button data-testid="add-client-type-btn">
            ...
            <DialogContent>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex justify-end gap-2 pt-4">
                  ...
                  <Button type="submit" data-testid="save-type-btn">Guardar</Button>
                </div>
              </form>
            </DialogContent>
          </Dialog>
